...
import { pgTable, timestamp, serial, char, text, integer, primaryKey } from 'drizzle-orm/pg-core';
...
export const categoriesToBooksRelations = relations(categories_to_books, ({ one }) => {
  return {
    book: one(books, {
